...
import aditya from '@/public/images/aditya.png'
import shreyash from '@/public/images/shreyash.png'
            ...
            <div className='w-full h-fit px-4 py-6 bg-white rounded-3xl flex flex-col gap-6'>
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex gap-3'>
                        ...
                        {/* profile image */}
                        <Image src={tushar} alt='tushar' className='h-10 w-10 rounded-full' />

                        <div>
                            {/* name */}
                            <h4 className='font-semibold capitalize text-sm'>Tushar Suryavanshi</h4>
                    ...
                    <div className='flex gap-3'>
                        ...
                        {/* profile image */}
                        <Image src={aditya} alt='Ajinkya' className='h-10 w-10 rounded-full' />

                        <div>
                            {/* name */}
                            <h4 className='font-semibold capitalize text-sm'>Aditya Shirke</h4>
                    ...
                    <div className='flex gap-3'>
                        ...
                        {/* profile image */}
                        <Image src={shreyash} alt='Ajinkya' className='h-10 w-10 rounded-full' />

                        <div>
                            {/* name */}
                            <h4 className='font-semibold capitalize text-sm'>Shreyash Tate</h4>
